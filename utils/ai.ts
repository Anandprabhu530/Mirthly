...
const parser = StructuredOutputParser.fromZodSchema(
    z.object({
        ...
        specific: z.string().describe("Give the one carrer path that is suitable for the person"),
        preffered:z.string().describe("Give the top trending jo in his requirement"),
    })
)
